#clim_cov stands for climate covariate
...
if(fit_clim_quants){
  ...
  file.remove(paste0("Data/processed/plain_clim_cov_quantile_model_fit_pars_num_quantiles_",num_quantiles,".csv"))
  ...
  for(q in seq_along(quantiles_to_estimate_bulk)){
    ...
    tibble(tau = zeta,
      ...
      write_csv(paste0("Data/processed/plain_clim_cov_quantile_model_fit_pars_num_quantiles_",num_quantiles,".csv"), append = T)
  }
}
...
quant_reg_model_pars = read_csv(paste0("Data/processed/plain_clim_cov_quantile_model_fit_pars_num_quantiles_",num_quantiles,".csv"),
...
obs_smoothed_quantiles %>% saveRDS(paste0("output/plain_clim_cov_quant_models_num_quantiles_",num_quantiles,".csv"))

#------------------------------------------------------------------------------------------------------------------

#obs_smoothed_quantiles = readRDS(paste0("output/plain_clim_cov_quant_models_num_quantiles_",num_quantiles,".csv"))
...
lambda_thresh_ex %>%
  write_csv(paste0("Data/processed/plain_clim_cov_thresh_exceedance_lambda_num_quantiles_",num_quantiles,".csv"))
...
clim_date_w_quantile_mod %>%
  saveRDS(paste0("output/plain_clim_cov_quant_models_clim_num_quantiles_",num_quantiles,".csv"))

quantile_model_fit_9 = readRDS("output/plain_threshold_model_9")
clim_date_w_quantile_mod = readRDS(paste0("output/plain_clim_cov_quant_models_clim_num_quantiles_",num_quantiles,".csv"))
...
#saving result
lambda_thresh_ex %>% 
  write_csv(paste0("Data/processed/plain_climate_clim_cov_thresh_exceedance_lambda_num_quantiles_",num_quantiles,".csv"))
