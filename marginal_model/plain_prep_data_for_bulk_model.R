...
raw_obs_data<- read.csv("Data/processed/plain_1971_2022_JJA_obs_data_bulk_model.csv", header=TRUE)
...
clim_quantiles_subset %>%
  saveRDS(paste0("Data/processed/plain_clim_data_for_bulk_model_num_quantiles_",num_quantiles,".csv"))
