...
if(fit_clim_quants){
  ...
  file.remove(paste0("Data/processed/altitude_quantile_model_fit_pars_num_quantiles_",num_quantiles,".csv"))
  ...
  for(q in seq_along(quantiles_to_estimate_bulk)){
    ...
    quantile_model_fit <- evgam(maxtp ~ value + altitude, obs_data_for_quant_reg,
    ...
    tibble(tau = zeta,
      ...
      write_csv(paste0("Data/processed/altitude_quantile_model_fit_pars_num_quantiles_",num_quantiles,".csv"), append = T)
  }
}
...
quant_reg_model_pars = read_csv(paste0("Data/processed/altitude_quantile_model_fit_pars_num_quantiles_",num_quantiles,".csv"),
...
obs_smoothed_quantiles %>% saveRDS(paste0("output/altitude_quant_models_num_quantiles_",num_quantiles,".csv"))
