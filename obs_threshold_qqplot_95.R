...
this_fit_mod = read_csv("output/gpd_model_fits/obs_threshold_model_1_true_95.csv") %>%
  unlist() %>% as.numeric
...
#  plyr::rbind.fill() %>%
#  as_tibble() 
#done for each value above threshold_95. We have dupplicates of stn, year because the transformation is done for every point. 
