...
data_for_rpareto = readRDS("Data/processed/clim_data_for_rpareto/true/robust_plain_data_for_rpareto")
...
fit <<- optimx::optimx(par = c(0.5, 0.5), fn = ngll ,hessian = F, method = 'Nelder-Mead') #used to have par = c(0.5,30)
